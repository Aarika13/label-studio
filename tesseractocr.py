...
def create_image_url(filepath):
    ...
    if filename:
        ...
        return None
# filepath =  r"/home/aarika/Desktop/New_OCR/train/image/"
# create_image_url(filepath)
...
# upload_url = 'http://localhost:8000/download/'  # Update with your server URL
# files = {'file': open('ocr_tasks.json', 'rb')}
